...
if [ "$CHECK" = true ]; then
  ...
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicalsix/ \
                                     --checkfiles YearCheckerMain.java --singlecomments 9 --multicomments 3 --language Java
  determine_exit_code $?
  # --> GatorGrader CHECK: the "int sum" fragment exists in the code at least once
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicalsix/ \
                                     --checkfiles YearCheckerMain.java --fragments "new Date(" --fragmentcounts 1
  determine_exit_code $?
  # --> GatorGrader CHECK: the "println(" fragment exists in the code at least set number of times
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicalsix/ \
                                     --checkfiles YearCheckerMain.java --fragments "println(" --fragmentcounts 9
  determine_exit_code $?
  # --> GatorGrader CHECK: the "new YearChecker(" fragment exists in the code at least set number of times
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicalsix/ \
                                     --checkfiles YearCheckerMain.java --fragments "new YearChecker(" --fragmentcounts 1
  determine_exit_code $?
  # --> GatorGrader CHECK: the correct number of comments in the Java code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicalsix/ \
                                     --checkfiles YearChecker.java --multicomments 6 --language Java
  determine_exit_code $?
  # --> GatorGrader CHECK: the "REFERENCE_YEAR" fragment exists in the code at least set number of times
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicalsix/ \
                                     --checkfiles YearChecker.java --fragments "REFERENCE_YEAR" --fragmentcounts 3
  determine_exit_code $?
  # --> GatorGrader CHECK: the "println(" fragment does not exist in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicalsix/ \
                                     --checkfiles YearChecker.java --fragments "println(" --fragmentcounts 0
  determine_exit_code $?
  echo ""
